...
class NODE_MT_gn_mesh_operations_base(node_add_menu.NodeMenu):
    ...
    def draw(self, context):
        del context
        layout = self.layout
        self.node_operator(layout, "GeometryNodeAdaptiveRemesh")
        self.node_operator(layout, "GeometryNodeBevel")
        self.node_operator(layout, "GeometryNodeDecimate")
        ...
        self.node_operator(layout, "GeometryNodeFixPoles")
        self.node_operator(layout, "GeometryNodeFlipFaces")
        self.node_operator(layout, "GeometryNodeHardBevel")
        self.node_operator(layout, "GeometryNodeInset")
        self.node_operator(layout, "GeometryNodeMeshBoolean")
        self.node_operator(layout, "GeometryNodeMergeSimilarIslands")
        self.node_operator(layout, "GeometryNodeMergeSmallIslands")
        ...
        self.node_operator(layout, "GeometryNodeSelectBadTriangles")
        self.node_operator(layout, "GeometryNodeShrinkwrap")
        self.node_operator(layout, "GeometryNodeSkeletonInset")
